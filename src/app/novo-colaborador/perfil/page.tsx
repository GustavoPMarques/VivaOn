...
const avisos = [
  {
    titulo: "Reunião:",
    texto:
      "No dia 12/11 haverá uma reunião onde todos os integrantes deverão comparecer.",
    tempo: "há 2 horas",
  },
  {
  ...
  },
  {
    titulo: "Eventos:",
    texto:
      "Venha visitar o estande da Vivo no nosso evento! Teremos demonstrações, brindes e muitas novidades! Acontece nos dias 22 e 23 de Novembro.",
    tempo: "há 2 dias",
  },
  {
    titulo: "Aviso Importante:",
    texto: "O prazo para entrega dos relatórios foi estendido até o dia 05/10.",
    tempo: "há 3 dias",
  },
  {
    titulo: "Treinamento:",
    texto:
      "Na próxima semana iniciaremos o treinamento de novas ferramentas digitais.",
    tempo: "há 5 dias",
  },
  {
    titulo: "Comunicado:",
    texto:
      "O acesso ao sistema ficará indisponível no sábado, das 14h às 18h, para manutenção.",
    tempo: "há 6 dias",
  },
  {
    titulo: "Parabéns!",
    texto:
      "Gostaríamos de parabenizar a equipe do Projeto Alpha pelo excelente desempenho.",
    tempo: "há 1 semana",
  },
  {
    titulo: "Campanha Solidária:",
    texto:
      "Estamos arrecadando alimentos e brinquedos para doação até o dia 20/12.",
    tempo: "há 2 semanas",
  },
];
...
const stats = [
  {
    icon: (
      <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
        <path
          d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16Zm-1-7V7h2v6h-2Zm0 4v-2h2v2h-2Z"
          fill="#663399"
        />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
        <path
          d="M17 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2Zm0 18H7V4h10v16Zm-5-3a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"
          fill="#663399"
        />
      </svg>
    ),
  ...
  return (
    <div className="w-full min-h-[80vh] flex flex-col">
      ...
      <div className="w-full flex justify-center mt-6 mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#663399] text-center w-full">
          Olá, {nome}!
        </h2>
      </div>
        ...
        <div className="flex items-center">
          <div className="flex gap-4 overflow-x-auto pb-2">
            {avisos.map((aviso, i) => (
              ...
              >
                <div>
                  <div className="font-bold text-base text-[#1a1a2e] mb-1">
                    {aviso.titulo}
                  </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-3xl mx-auto mb-12">
        <div className="col-span-1 sm:col-span-2 flex flex-col items-center justify-center bg-white rounded-xl shadow p-6 min-h-[120px] cursor-pointer hover:shadow-md transition">
          <svg width="48" height="48" fill="none" viewBox="0 0 24 24">
            ...
            />
            <circle cx="12" cy="12" r="10" stroke="#663399" strokeWidth="2" />
          </svg>
          <span className="mt-2 font-semibold text-[#663399] text-lg">
            Minha performance
          </span>
        </div>
        <div className="col-span-1 sm:col-span-2 flex flex-col items-center justify-center bg-white rounded-xl shadow p-6 min-h-[120px] cursor-pointer hover:shadow-md transition">
        ...
        {stats.map((stat, i) => (
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-bold text-lg text-[#663399]">
                {stat.value}
              </span>
